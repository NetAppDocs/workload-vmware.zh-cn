...
+
规划中心已显示。在规划中心，您可以上传虚拟机清单数据，查看以前的清单数据上传，并使用任何虚拟机清单数据集规划迁移。
...
在 https://www.dell.com/en-us/shop/vmware/sl/rvtools["了解有关RVTools的更多信息"^]
...
. 输入您将创建的 VM 清单数据集的名称。
. 从以下位置下载并安装 RVTools 4.4.2 或更高版本： https://www.dell.com/en-us/shop/vmware/sl/rvtools["RVTools网站"^]
...
+
请参阅“命令行参数”章节。 https://www.dell.com/en-us/shop/vmware/sl/rvtools["RVTools 文档位于“资源”部分"^] 详情请见下文。
...
* link:launch-migration-advisor-gcve.html["创建 Google Cloud VMware Engine 部署计划"]
