...
https://www.dell.com/en-us/shop/vmware/sl/rvtools["了解有关RVTools的更多信息"^]
...
+
请参阅“命令行参数”章节。 https://www.dell.com/en-us/shop/vmware/sl/rvtools["RVTools文档"^] 详情请见下文。
...
+
规划中心已显示。在规划中心，您可以上传虚拟机清单数据，查看之前的清单数据上传记录，并使用任何虚拟机清单数据集规划迁移，然后选择“迁移到 AWS 原生计算”。显示 VMware 迁移顾问启动画面。
...
. 选择 * 保存 * 。
. 选择*复制API访问令牌*。
. 保存此令牌以准备与 Workload Factory 迁移顾问一起使用。
