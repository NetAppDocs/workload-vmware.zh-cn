...
.步骤
. 下载并安装 RVTools 4.4.2 或更高版本 https://www.dell.com/en-us/shop/vmware/sl/rvtools["RVTools网站"^]
...
+
请参阅“命令行参数”章节。 https://www.dell.com/en-us/shop/vmware/sl/rvtools["资源部分的 RVTools 文档"^] 详情请见下文。
